...
(function(global, factory) {
    ...
    function createElement(
        ...
        // console.log(alwaysNormalize, normalizationType, 'alwaysNormalizealwaysNormalizealwaysNormalizealwaysNormalize');
    ...
    function initRender(vm) {
        ...
        vm._c = function(a, b, c, d) {
            // console.log('_c方法=-=-===---_c方法');
            return createElement(vm, a, b, c, d, false);
        };
        // normalization is always applied for the public version, used in
        // user-written render functions.
        vm.$createElement = function(a, b, c, d) {
            // console.log('$createelement方法==============');
    ...
    function initEvents(vm) {
        ...
        // console.log(listeners, '=11221212121listenerslistenerslisteners');
        if (listeners) {
    ...
    function initUse(Vue) {
        ...
        Vue.use = function(plugin) {
            // 第一次使用use的时候初始化插件数组，之后直接返回
            var installedPlugins =
                this._installedPlugins || (this._installedPlugins = []);
            // 如果已经存在该插件，那么返回Vue，这样的话支持链式操作了
    ...
    function createPatchFunction(backend) {
        ...
        function createElm(
            ...
            // initRender 中 初始化的_vnode
            // vnode的真实dom存在 && 所在的vnode数组
            ...
            if (isUndef(oldVnode)) {
                ...
                if (!isRealElement && sameVnode(oldVnode, vnode)) {
                    ...
                    createElm(
                        ...
                        nodeOps.nextSibling(oldElm) // 返回当前节点所属父节点中子节点数组的紧随当前节点的下一个子节点（包括所有节点）
                        // nextElementSibling 同上，不过只包含元素节点
                    );
